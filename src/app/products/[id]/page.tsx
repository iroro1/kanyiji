...
export default function ProductDetailPage({ params }: { params: { id: string } }) {
  ...
  const product = {
    ...
    price: 2500,
    originalPrice: 3000,
    description: "Beautiful handcrafted beaded necklace made with traditional African techniques. Each bead is carefully selected and strung by skilled artisans from Nigeria. This piece represents the rich cultural heritage and craftsmanship of West Africa.",
    images: [
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="flex items-center">
                <div className="flex items-center">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className={`w-4 h-4 ${i < Math.floor(product.vendor.rating) ? 'text-yellow-400 fill-current' : 'text-gray-300'}`} />
                  ))}
                </div>
        ...
        <div className="mt-16 bg-white rounded-2xl p-8 border border-gray-200">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-gray-600">Authentic products, verified vendors</p>
            </div>
          </div>
        </div>
      </div>
