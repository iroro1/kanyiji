...
export default function VendorDashboard() {
  ...
  const orders: Order[] = [
    ...
    },
    {
      ...
      productName: 'Wooden African Mask',
      amount: 4500,
      status: 'shipped',
      date: '2024-01-13',
    },
  ...
  const stats = [
    ...
    { label: 'Active Orders', value: orders.filter(o => o.status === 'pending' || o.status === 'processing').length, icon: ShoppingBag, color: 'text-green-600' },
    { label: 'Monthly Sales', value: '₦125,000', icon: TrendingUp, color: 'text-purple-600' },
    { label: 'Total Customers', value: 45, icon: Users, color: 'text-orange-600' },
  ];
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-lg font-semibold text-gray-900">₦98,000</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Growth</span>
                    <span className="text-lg font-semibold text-green-600">+27.6%</span>
                  </div>
                </div>
              </div>
