/**
 * Setup Admin User with +admin email
 * 
 * Run this with: node setup-admin-with-plus-email.js
 */
...
const ADMIN_EMAIL = 'kanyiji.dev+admin@gmail.com';  // Email with +admin
const ADMIN_PASSWORD = '#amazingroot';

async function setupAdminUser() {
  try {
    console.log('🚀 Setting up admin user with +admin email...\n');
    ...
    if (existingUser) {
      ...
      console.log('➕ Creating new user with +admin email...');
    ...
    if (profile && profile.role === 'admin') {
      ...
      console.log('\n📧 Note: Gmail treats +admin as an alias, but Supabase treats it as a unique email.');
    } else {
